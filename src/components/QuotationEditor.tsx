      ...
      <header className="bg-zinc-900 border-b border-zinc-800 py-4 px-6 flex items-center justify-between no-print sticky top-0 z-40">
        ...
        <div className="flex bg-zinc-950 p-1 rounded-lg border border-zinc-800">
          <button 
            ...
            className={`px-3 py-1.5 text-xs font-semibold rounded ${previewTab === "edit" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:text-zinc-200"}`}
          >
            {t("formTab")}
          </button>
          <button 
            ...
            className={`px-3 py-1.5 text-xs font-semibold rounded ${previewTab === "client-preview" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:text-zinc-200"}`}
          >
            {t("clientTab")}
          </button>
          <button 
            ...
            className={`px-3 py-1.5 text-xs font-semibold rounded ${previewTab === "company-preview" ? "bg-zinc-800 text-white" : "text-zinc-400 hover:text-zinc-200"}`}
          >
            {t("companyTab")}
          </button>
        </div>
